...
export default function HomePage() {
  ...
  return (
    <div className="bg-neutral-950 pb-10 md:pb-16">
      <section className="relative flex min-h-[calc(100vh-116px)] w-full flex-col overflow-hidden md:min-h-[calc(100vh-80px)]">
        <div className="absolute inset-0">
          <Image
            ...
            fill
            priority
            className="object-cover object-[center_28%] sm:object-[center_22%] lg:object-center"
            sizes="100vw"
          />
          <div
          ...
          <div className="flex flex-1 flex-col justify-center">
            ...
            <div className="mt-6 flex w-full max-w-md flex-col gap-3 sm:mt-8 sm:max-w-none sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
              <Button
                ...
                size="lg"
                variant="ghost"
                className="bg-primary text-primary-foreground hover:bg-primary/80 h-12 w-full rounded-md px-3 text-sm font-bold uppercase shadow-none sm:w-fit sm:px-10 md:px-16 md:text-base"
                asChild
              >
              ...
              {isAvailable && (
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="inline-flex h-12 w-full cursor-pointer items-center justify-center gap-2 rounded-md border border-white bg-transparent px-3 text-sm font-bold text-white uppercase shadow-none hover:bg-white/10 hover:text-white sm:w-fit sm:justify-start sm:gap-2.5 sm:px-10 md:px-16 md:text-base dark:border-white dark:bg-transparent dark:hover:bg-white/10"
                  onClick={open}
                >
                  <span
            ...
            <div className="grid grid-cols-1 justify-start gap-0 sm:grid-cols-[repeat(3,max-content)] sm:gap-x-0 lg:justify-center">
              {[
                ...
                <div
                  key={key}
                  className={cn(
                    'flex items-center gap-3 px-1 py-3 sm:px-4 sm:py-0',
                    i > 0 && 'border-white/15 pt-4 sm:border-l sm:pt-0',
                  )}
                >
                  {renderIcon()}
      ...
      <section className="relative z-20 mx-auto mt-4 max-w-7xl px-3 sm:px-4 md:px-6 lg:px-10">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 md:grid-cols-4 lg:grid-cols-7 lg:gap-6">
            {CATEGORY_LINKS.map((cat) => (
              <Link key={cat.label} href={cat.href} className="group flex flex-col items-center text-center">
                <div className="border-primary/40 group-hover:border-primary flex h-20 w-full items-center justify-center rounded-2xl border bg-neutral-900/40 p-4 transition group-hover:bg-neutral-900/70">
                  <Image
                    src={cat.image}
                    alt=""
                    width={80}
